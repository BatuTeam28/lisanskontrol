...
import webbrowser
os.system('clear')
logo = render('''BATU         NEW      META''', font='block', colors=['blue', 'white'], align='center', space=True)
print("═" * 50 + "\033[0m")
print(logo)
print("""      🌐𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌: @BatuX28   📡 𝐊𝐀𝐍𝐀𝐋 : @BatuPython28""")

print("═" * 50 + "\033[0m")
TELEGRAM_BOT_TOKEN = input("\x1b[1;32m 𝐓𝐨𝐤𝐞𝐧 𝐆𝐢𝐫 : \x1b[1;33m")
print("═" * 47 + "\033[0m")
TELEGRAM_CHAT_ID = input("\x1b[1;32m 𝐈𝐝 𝐆𝐢𝐫 : \x1b[1;33m")
takipcisec = int(input("𝙈𝙞𝙣𝙞𝙢𝙪𝙣 𝙏𝙖𝙠𝙞𝙥𝙘𝙞 𝙂𝙞𝙧 : "))
...
📡 𝐊𝐀𝐍𝐀𝐋 : @BatuPython28 ~ @BatuVip_Bot
──────────────────────
🌐 𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌: @BatuX28 ~ @BatuVip_Bot
"""
        print(mesaj)
...
def weoxarayuz(email):
    ...
    print(f'''
\033[1;32m[✓] 𝙃𝙞𝙩 𝙄𝙜 : {hit_ig} 
\033[1;33m[!] 𝙂𝙤𝙤𝙙 𝙄𝙜 : {iyi_ig} 
\033[1;31m[✗] 𝘽𝙖𝙙 : {bad_ig}  
\033[1;31m[✗] 𝘽𝙖𝙙 𝙂𝙢 : {bad_gm}
\033[1;32m[✓] 𝘽𝙖𝙙 : {toplam}     
\033[1;36m[@] 𝙀𝙢𝙖𝙞𝙡 : {email}     
''')
